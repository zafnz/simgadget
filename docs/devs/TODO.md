...
- [x] **#26** Step #26 is a manual step ("Hardware > Rotate Left") that an agent cannot perform. **Documented as human-in-the-loop** — [TESTING_TOOLS.md:254](../testing/TESTING_TOOLS.md:254) says outright that no MCP client can perform it. The other resolution, a rotation tool, is still open as #26 under 2.0.3 candidates.
