...
- [`idb.proto`](https://github.com/facebook/idb/blob/main/proto/idb.proto) — the actual contract this server speaks. Vendored at `vendor/idb/proto/idb.proto`; `CompanionService` is the service, and the accessibility, HID and screenshot messages are the ones in use.
